...
rotor1Position = [1 1 1];
rotor2Position = [1 1 -1];
rotor3Position = [1 -1 1];
rotor4Position = [1 -1 -1];
rotor5Position = [-1 1 1];
rotor6Position = [-1 1 -1];
rotor7Position = [-1 -1 1];
rotor8Position = [-1 -1 -1];
...
for index=0:N    
    ...
    inR5Position = rotor5Position;
    inR6Position = rotor6Position;
    inR7Position = rotor7Position;
    inR8Position = rotor8Position;
    
        
    inTMPosition = [0 0 0];
    
    forDist = [forDist; calculateForce(inCylMass, inCylRadius, inCylLength,inQuadRadius, inTMMass,...
        inTMLength, inTMRadius, inTMWidth, inTMPosition, inR1Position, ...
        inR2Position, inR3Position, inR4Position, inR5Position, ...
        inR6Position, inR7Position, inR8Position)]; 
...
for index=0:N    
    ...
    inR5Position = rotor5Position+randn(1,3).*rotorPositionErr;
    inR6Position = rotor6Position+randn(1,3).*rotorPositionErr;
    inR7Position = rotor7Position+randn(1,3).*rotorPositionErr;
    inR8Position = rotor8Position+randn(1,3).*rotorPositionErr;
